...
// The sidetone - this should normally be the same as
// SIDETONE_FREQUENCY in wwvb.h. But it must be the
// frequency of the audio tone being received in the
// line input.
#define MARK_FREQ SIDETONE_FREQUENCY
...
// For now, try this with float - works OK
// and is better on a T3.6 which has hardware
// floating point
#define double float
...
//printf("mag_limit = %14.1f\n",mag_limit);
    ...
    if(sample > mag_limit) {
      o_count++;
// 201102 Switch them to show polarity I'm used to 
